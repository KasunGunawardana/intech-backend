...
<div class="uk-section-small uk-section-default header">
    <div class="uk-container uk-container-large">
        <h1><span class="ion-speedometer"></span>Gallery Module</h1>
            ...
            <form method="POST" action="{{ route('gallery.update', $gallery->id) }}">
                ...
                <fieldset class="uk-fieldset">
                    ...
                    <div class="uk-margin input-wrapper ">
                        <label class="uk-form-label" for="show_nav">Enable Gallery Module</label>
                        <div class="m-6">
                        ...
                        <div class="uk-margin-small-top small-note"><span class="uk-badge">Note</span>[Enable this to show the gallery link in the main navigation]</div>
                    </div>

                    <div class="uk-margin input-wrapper ">
                        <label class="uk-form-label" for="sub_heading">Sub Heading</label>
                        <input class="uk-input" id="sub_heading" name="sub_heading" type="text" placeholder="Sub Heading" value="{{ (isset($gallery)) ? $gallery->sub_heading : ''}}">
                    </div>
