...
class CoursesSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $instructor7 = Instructor::create([
            'name' => 'Dr. Harshana Jayashantha De Silva',
            'title' => 'Accountant',
            'description' => '<ul class="instructors-ul" data-uk-scrollspy="target: >li; cls: uk-animation-slide-right; delay: 300"><li><!--block-->BSc. Eng (Hons), Electronic and Telecommunication Engineering (University of Moratuwa)</li><li><!--block-->MSc. Telecommunication (University of Moratuwa)</li><li><!--block-->Master of Business Administration(University of Sunderland) U.K.</li><li><!--block-->Doctor of Buisness administration (Aldersgate College, Philippines)</li><li><!--block-->VCP, MCSE,PMP (USA),CEH, CHFI, CISSP<br>Chartered Engineer (IESL)</li><li><!--block-->Certified Management Accountant (ICMA – Australia)</li></ul>',
        ...
        $course5 = Course::create([
            'name' => 'Certificate in 3D Animation I',
            'url' => 'certificate-in-3d-animation-i',
            'heading' => 'Learn 3D Animation ( Max & Maya) from Scratch',
        ...
        $course9 = Course::create([
            'name' => 'Certificate in Video Production',
            'url' => 'certificate-in-video-production',
            'heading' => 'Learn Video production from Scratch',
            'sub_heading' => 'Become a Successful post-production Expert',
            'meta_title' => 'Certificate in Video Production | INTECH | Reinvent Your Future',
            'meta_description' => 'Video production is the integration of audiovisuals with movements. Video Production is successfully completed with seamless pre-production,  production
            and post-production process. Production planning, scriptwriting, timeline planning, and equipment arrangements include in the pre-production period. Videography is done during production, whereas the quality of the clips and the total video is edited in the post-production period, telling a smooth and consistent story with sound and light controls.',
            'keywords' => 'Television & Film, Video Production Workflow, Producing, Scripting, Directing, Screenplay Storyboard, Cinematography & Lighting, Production Design, Art Direction, Costume Design Make-up, Editing & VFX, Presenting, Acting & Modeling, Choreography, Casting, Final Projects',
            ...
            'syllabus' => '<ul><li><!--block--><strong>Television & Film / Video Production Workflow / Producing / Scripting / Directing / Screenplay Storyboard / Cinematography & Lighting / Production Design / Art Direction / Costume Design Make-up / Editing & VFX / Presenting, Acting & Modeling / Choreography / Casting / Final Projects</li></ul>',
            'requirements' => '<ul><li><!--block-->You must be at least 16 years old when you enroll.</li><li><!--block-->Passes in five subjects (in any subject stream) at the G.C.E. (Ordinary Level) Examination or Certificate in computer science (INTECH) or Certificate in Graphic Designing (INTECH)</li><li><!--block-->Certificate in Video Editing &amp; Vfx (INTECH).</li></ul>',
            'duration' => '6 Months (145 Hours)',
            'price' => '39,900',
            'medium' => 'Sinhala / English',
        ...
        $course10 = Course::create([
            ...
            'url' => 'certificate-in-autocad',
            'heading' => 'Learn AutoCAD from Scratch',
            'sub_heading' => 'Become a Successful Architecture',
            'meta_title' => 'Certificate in AutoCAD | INTECH | Reinvent Your Future',
            'meta_description' => 'AutoCAD is an industry that provides many commercial services. AutoCAD for desktop computers was first introduced in 1982, which was then developed for mobile and as a web app in 2010. Architects, engineers, graphic designers, project managers and other professionals use AutoCAD for blueprints, building plans, etc. AutoCAD requires knowledge in 2D and 3D.',
            'keywords' => 'Television & Film, Video Production Workflow, Producing, Scripting, Directing, Screenplay Storyboard, Cinematography & Lighting, Production Design, Art Direction, Costume Design Make-up, Editing & VFX, Presenting, Acting & Modeling, Choreography, Casting, Final Projects',
            'content' => '<div><!--block-->AutoCAD is an industry that provides many commercial services. AutoCAD for desktop computers was first introduced in 1982, which was then developed for mobile and as a web app in 2010. Architects, engineers, graphic designers, project managers and other professionals use AutoCAD for blueprints, building plans, etc. AutoCAD requires knowledge in 2D and 3D.<br></div>',
            'syllabus' => '<ul><li><!--block-->Setting up a Drawing</li><li><!--block-->Basic Drawing Commands</li><li><!--block-->Editing Drawings</li><li><!--block-->Advanced Drawing Editing</li><li><!--block-->Drawing Organization</li><li><!--block-->Advanced Object Types</li><li><!--block-->Hatching</li><li><!--block-->Dimensioning</li><li><!--block-->Adding Text</li><li><!--block-->Printing</li></ul>',
        ...
        $course21 = Course::create([
            ...
            'url' => 'certificate-in-networking',
            'heading' => 'Learn Networking',
            'sub_heading' => 'Become a Successful Networking Engineer',
            'meta_title' => 'Certificate in Networking | INTECH | Reinvent Your Future',
            'meta_description' => 'Thanks to new technologies, networks are becoming more intelligent, programmable and software-driven. Networking Academy courses support this evolution and expose learners to new concepts and hands-on experiences.',
            'keywords' => 'Pre-Production, Video Production Workflow, Introduction to Post-Production, Linear and Nonlinear Editing, Editing Rule and Ethics, Vfx, Adobe Premier: (Understanding the Interface & Basic, Importing to Raster and Vector Graphic, Tools & Techniques, Effects and Transitions, Project Handling and finalized ), Audio Production, Adobe Audition: (Audio Recording, Instruments & Technology, Sound Design for Video Production, Sound Mixing), Adobe After Effects: (Importing to Raster and Vector Graphic, Tools & Techniques, Text Animations, 3D Animation in After Effects, Special Effects, Plugins and Tips), Visual effects and Project Finalizing, Plugins & Techniques, Hardware & Equipment, Color Corrections, Color Grading, Converting and Exporting, Organizing an idea, Scripting, Story Board Design, Video Formats and Finalizing, Final Projects',
            'content' => '<div><!--block-->Thanks to new technologies, networks are becoming more intelligent, programmable and software-driven. Networking Academy courses support this evolution and expose learners to new concepts and hands-on experiences.<br></div>',
            'syllabus' => '<div>Network Fundamentals / IP connectivity and services / Server & Storage Fundamentals / Security Fundamentals / Trending technologies</div>',
            'requirements' => '<ul><li><!--block-->You must be at least 16 years old when you enroll.</li></ul>',
            'duration' => '4 months',
            'price' => '49,900',
            'medium' => 'Sinhala / English',
